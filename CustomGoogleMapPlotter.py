...
if __name__ == "__main__":
    ...
    df = pd.read_csv(r"C:\Users\redwi\Downloads\combo.csv")

    df = df[df["TAKE"] == "Interest"]

    gmap = CustomGoogleMapPlotter(df["LAT"].iloc[100], df["LON"].iloc[100], initial_zoom,
                                  map_type='satellite', apikey='JgLmLWBBGazcWxMxucfMM5jB1I0=')
    gmap.color_scatter(df["LAT"], df["LON"], df["UV"], colormap='GnBu', size=1)
